...
begin
  ...
  begin
    close;
    sql.clear;
    sql.add('select top 5 c.comentario, u.nome from comentario c, usuario u where c.anuncioid = :anuncioid and u.usuarioid = c.usuarioid order by comentarioid desc');
